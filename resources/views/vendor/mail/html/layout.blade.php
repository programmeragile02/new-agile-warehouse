...
{{-- Inline agile.css jika tersedia --}}
@php
  $agileCssPath = public_path('mail/agile.css');
  $defaultCssPath = resource_path('views/vendor/mail/html/themes/default.css'); // tetap dipakai oleh Laravel
@endphp
@if (file_exists($agileCssPath))
  <style>{!! file_get_contents($agileCssPath) !!}</style>
@endif
{!! $head ?? '' !!}
</head>
<body>
<table class="wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation"
       style="background:#0b1437;"> {{-- NAVY --}}
<tr>
<td align="center">
<table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
