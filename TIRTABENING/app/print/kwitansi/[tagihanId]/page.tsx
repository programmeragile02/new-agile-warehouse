...
export default async function KwitansiPage({
    ...
    const nomorKwitansi =
        `KW-${new Date().getFullYear()}${String(
            new Date().getMonth() + 1
        ).padStart(2, "0")}` +
...
.logo{ width:50px; height:50px; border-radius:10px; flex-shrink:0; overflow:hidden; display:flex; align-items:center; justify-content:center; }
