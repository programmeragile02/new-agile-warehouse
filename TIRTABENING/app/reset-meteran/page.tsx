...
export default function ResetMeteranPage() {
    ...
    async function maybeUpdateCustomerZone(
        pelangganId: string,
        zonaId: string
    ) {
    ...
    const handleDelete = async (id: string) => {
        if (!id) return;
        if (
            confirm("Apakah Anda yakin ingin menghapus data reset meter ini?")
        ) {
            try {
                    ...
                    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-indigo-100 p-4 pb-24">
                        ...
                        <AppHeader
                            ...
                            titleExtra={
                                ...
                                >
                                    <b>Reset Meteran</b> dipakai saat meter
                                    rusak/bermasalah atau ada indikasi
                                    kecurangan. Pilih pelanggan, isi tanggal
                                    penggantian dan angka <i>meter awal baru</i>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-gray-600 mb-4">
                                        Gunakan menu ini untuk mencatat
                                        pergantian meter pelanggan.
                                    </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem value="2025-09">
                                                September 2025
                                            </SelectItem>
                                            <SelectItem value="2025-08">
                                                Agustus 2025
                                            </SelectItem>
                                            <SelectItem value="2025-07">
                                                Juli 2025
                                            </SelectItem>
                                        </SelectContent>
                                    </Select>
