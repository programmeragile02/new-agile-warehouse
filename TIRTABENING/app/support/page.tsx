                            ...
                            >
                                    ...
                                    >
                                        ...
                                        <AccordionItem value="step3">
                                            ...
                                            <AccordionContent className="text-sm">
                                                Buka <b>WhatsApp Setting</b>{" "}
                                                lalu lakukan <b>scan QR</b>.
                                                Setelah tersambung, sistem akan
                                                dapat mengirim tagihan &
                                                pengingat otomatis.
                                            </AccordionContent>
                                        </AccordionItem>
                                        ...
                                        <AccordionItem value="step4">
                                            ...
                                            <AccordionContent className="text-sm leading-relaxed">
                                                <ol className="list-decimal pl-5 space-y-1">
                                                    ...
                                                    <li>
                                                        Input <b>Pelanggan</b>:
                                                        identitas, alamat, nomor
                                                        WA, dan{" "}
                                                        <b>meter awal</b>.
                                                        (Catatan: meter awal
                                                        tidak bisa diubah
                                                        setelah masuk ke Catat
                                                        Meter.)
                                                    </li>
                                                </ol>
                                            </AccordionContent>
                                        ...
                                        <AccordionItem value="step5">
                                            ...
                                            <AccordionContent className="text-sm">
                                                Pilih <b>Periode</b> (mis.
                                                2025-09), lalu klik{" "}
                                                <b>Generate Jadwal</b>. Sistem
                                                otomatis membuat jadwal catat
                                                meter per petugas.
                                            </AccordionContent>
                                        </AccordionItem>
                                        ...
                                        <AccordionItem value="step7">
                                            ...
                                            <AccordionContent className="text-sm">
                                                ...
                                                bukti terverifikasi, sistem
                                                otomatis mengirim{" "}
                                                <b>Kwitansi</b> via WA. Tersedia
                                                tombol <b>Kirim WA</b> sebagai
                                                reminder.
                                            </AccordionContent>
                                        </AccordionItem>
                                    </Accordion>
                                ...
                                <GlassCard className="p-6">
                                    ...
                                    <p className="text-sm text-muted-foreground mt-3">
                                        Video ringkas dari login hingga
