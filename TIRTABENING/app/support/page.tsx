                                ...
                                >
                                    <AccordionItem value="step1">
                                        ...
                                        <AccordionContent className="text-sm leading-relaxed">
                                            <ul className="list-decimal pl-5 space-y-1">
                                                <li>
                                                    Login pertama menggunakan{" "}
                                                    <b>akun_id</b> dan{" "}
                                                    <b>password</b>.
                                                </li>
                                                <li>
                                                    Setelah berhasil, login
                                                    kedua sebagai <b>User</b>{" "}
                                                    (username & password).
                                                </li>
                                                <li>
                                                    Login <i>akun_id</i> hanya
                                                    dilakukan sekali;
                                                    selanjutnya aplikasi
                                                    otomatis masuk sebagai User.
                                                </li>
                                            </ul>
                                        </AccordionContent>
                                    </AccordionItem>
                                    ...
                                    <AccordionItem value="step3">
                                        ...
                                        <AccordionContent className="text-sm">
                                            Buka <b>WhatsApp Setting</b> lalu
                                            lakukan <b>scan QR</b>. Setelah
                                            tersambung, sistem akan dapat
                                            mengirim tagihan & pengingat
                                            otomatis.
                                        </AccordionContent>
                                    </AccordionItem>
                                    ...
                                    <AccordionItem value="step4">
                                        ...
                                        <AccordionContent className="text-sm leading-relaxed">
                                            <ol className="list-decimal pl-5 space-y-1">
                                                ...
                                                <li>
                                                    Isi <b>Blok/Gang</b>, pilih{" "}
                                                    <b>Petugas</b> penanggung
                                                    jawabnya.
                                                </li>
                                                <li>
                                                    Input <b>Pelanggan</b>:
                                                    identitas, alamat, nomor WA,
                                                    dan <b>meter awal</b>.
                                                    (Catatan: meter awal tidak
                                                    bisa diubah setelah masuk ke
                                                    Catat Meter.)
                                                </li>
                                            </ol>
                                        </AccordionContent>
                                    ...
                                    <AccordionItem value="step5">
                                        ...
                                        <AccordionContent className="text-sm">
                                            Pilih <b>Periode</b> (mis. 2025-09),
                                            lalu klik <b>Generate Jadwal</b>.
                                            Sistem otomatis membuat jadwal catat
                                            meter per petugas.
                                        </AccordionContent>
                                    </AccordionItem>
                                    ...
                                    <AccordionItem value="step6">
                                        <AccordionTrigger>
                                            6) Catat Meter, Finalisasi & Kirim
                                            Tagihan
                                        </AccordionTrigger>
                                        <AccordionContent className="text-sm leading-relaxed">
                                            ...
                                            <ul className="list-disc pl-5 mt-2 space-y-1">
                                                <li>
                                                    Klik <b>Catat Sekarang</b>{" "}
                                                    dari jadwal, isi{" "}
                                                    <b>meter akhir</b>, lalu{" "}
                                                    <b>Simpan</b>.
                                                </li>
                                                <li>
                                                    Jika sudah fix, klik{" "}
                                                    <b>Finalisasi</b> (ikon
                                                    kunci). Sistem langsung
                                                    membuat <b>Tagihan</b> dan
                                                    mengirim <b>WA</b> ke
                                                    pelanggan.
                                                </li>
                                                <li>
                                                    Setelah finalisasi, data
                                                    catat meter <b>terkunci</b>{" "}
                                    ...
                                    <AccordionItem value="step7">
                                        ...
                                        <AccordionContent className="text-sm">
                                            Masuk ke <b>Tagihan</b> →{" "}
                                            <b>Input Pembayaran</b>. Setelah
                                            bukti terverifikasi, sistem otomatis
                                            mengirim <b>Kwitansi</b> via WA.
                                            Tersedia tombol <b>Kirim WA</b>{" "}
                                            sebagai reminder.
                                        </AccordionContent>
                                    </AccordionItem>
                                </Accordion>
                            ...
                            <GlassCard className="p-6">
                                ...
                                <div className="w-full aspect-video rounded-xl overflow-hidden bg-black/50">
                                    <iframe
                                        ...
                                        title="Tutorial Penggunaan Nata Banyu"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                        allowFullScreen
                                    />
                                </div>
                                <p className="text-sm text-muted-foreground mt-3">
                                    Video ringkas dari login hingga finalisasi &
                                    pembayaran.
                                </p>
                            </GlassCard>
                        </TabsContent>
