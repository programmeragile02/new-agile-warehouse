...
export default function KonsumsiZonaPage() {
    ...
    useEffect(() => {
        ...
        return () =>
            window.removeEventListener("export-kz-excel", onExcel as any);
    }, [month, zone, q]);
