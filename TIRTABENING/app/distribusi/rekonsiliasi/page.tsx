...
export default function RekonsiliasiPage() {
  ...
  const tipTitle = (
    <>
      <strong>Rekonsiliasi</strong> membandingkan total <em>air masuk</em> dari
      meter tandon dengan <em>air keluar</em>:
      <br />
      • Level Tandon: input tandon vs total yang dialirkan ke blok.
      <br />
      • Level Blok: input blok vs total pemakaian rumah.
      <br />• Level Pelanggan: angka pemakaian per rumah pada periode tersebut.
    </>
  );
  const tipTandon = (
    <>
      ...
      <em>Total masuk ke blok (m³)</em>. Selisih = kebocoran/ketidakcocokan
      di antara tandon &gt; jaringan blok.
    </>
  );
  const tipBlok = (
    <>
      <strong>Blok</strong>: membandingkan <em>Air ke blok (m³)</em> dengan{" "}
      <em>Total pemakaian rumah (m³)</em>. Selisih = potensi kebocoran di
      distribusi dalam blok atau data meter rumah yang belum lengkap.
    </>
  );
  const tipRumah = (
    <>
      <strong>Pelanggan</strong>: daftar pemakaian (m³) tiap rumah untuk periode{" "}
      {periodeLabel || "-"} dari meter pelanggan.
    </>
  );
        ...
        <div className="px-0 grid grid-cols-1 md:grid-cols-3 gap-3 pb-4">
          <GlassCard className="p-4">
            <div className="flex items-center gap-1">
              ...
              >
                Total kumulatif input meter di semua tandon pada periode dipilih.
              </InfoTip>
            </div>
            <div className="text-lg font-bold">
              {loading ? "-" : num(totalInputTandon)}
          ...
          <GlassCard className="p-4">
            <div className="flex items-center gap-1">
              ...
              <InfoTip ariaLabel="Info total ke blok">
                Total kumulatif yang tercatat mengalir dari tandon ke seluruh
                blok pada periode dipilih.
              </InfoTip>
            </div>
            <div className="text-lg font-bold">
              {loading ? "-" : num(totalOutputBlok)}
            ...
            <div>
              <div className="flex items-center gap-1">
                ...
                <InfoTip ariaLabel="Info selisih total">
                  Selisih = Air masuk tandon − Air ke blok. Persentase =
                  Selisih ÷ Air masuk tandon × 100%.
                </InfoTip>
              </div>
              <div className="text-lg font-bold">
                {loading
