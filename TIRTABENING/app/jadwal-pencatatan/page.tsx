    ...
    return (
        <AuthGuard requiredRole={["ADMIN", "PETUGAS"]}>
            <PermissionGate
                ...
                fallback={
                    <AclDeniedAlert path="/jadwal-pencatatan" action="view" />
                }
            >
                <AppShell>
                    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50">
                        <div className="container mx-auto px-4 py-6">
                            ...
                            <div className="relative z-20">
                                <AppHeader
                                    ...
                                    titleExtra={
                                        ...
                                        >
                                            <strong>Jadwal Pencatatan</strong>{" "}
                                            dipakai untuk membuat rencana
                                            pencatatan meter bagi petugas. Klik{" "}
                                            <em>Generate Jadwal</em> pada bar di
                                            bawah, pilih periode dan cakupan
                                            yang diinginkan, lalu sistem akan
                                            otomatis membuatkan daftar jadwal.
                                            Jadwal yang terbuat akan tampil di
                                            tabel dan bisa langsung dipakai
                                            untuk aksi catat meter.
                                        </InfoTip>
                                    }
                                />
                            </div>
                            ...
                            <GlassCard className="p-6 mb-6 mt-4">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted-foreground">
                                                Kelola jadwal bulanan, status,
                                                dan aksi catat meter
                                            </p>
                                        </div>
                                    </div>
