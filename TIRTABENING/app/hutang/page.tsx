        ...
        try {
            ...
            if (!res.ok || !j?.ok) {
                ...
                if (String(err).toUpperCase().includes("NOBUKTI_DUPLICATE")) {
                    throw new Error(
                        "No Bukti sudah dipakai. Gunakan nomor lain."
                    );
                }
                throw new Error(err);
            }
    ...
    const actuallyDelete = async () => {
        ...
        try {
            const res = await fetch(
                `/api/hutang?id=${encodeURIComponent(id)}`,
                {
                    method: "DELETE",
                }
            );
                        ...
                        <GlassCard className="p-6 mb-6">
                          ...
                          />
                                                ...
                                                <div className="space-y-2 md:col-span-2">
                                                    ...
                                                    <Input
                                                        placeholder="Masukkan nama/instansi pemberi hutang"
                                                        value={form.pemberi}
                                                        onChange={(e) =>
                                                            onChange(
                                                                "pemberi",
