...
export default function MasterBiayaPage() {
    ...
    const [deletingBiaya, setDeletingBiaya] = useState<MasterBiaya | null>(
        null
    );
    ...
    const handleDeleteConfirm = async () => {
        if (deletingBiaya) {
            ...
            toast({
                title: "Berhasil",
                description: "Kategori Biaya dihapus.",
            });
