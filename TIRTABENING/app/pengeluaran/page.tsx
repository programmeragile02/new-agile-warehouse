    ...
    const openDeleteDialog = (id: string) => {
        ...
        if (target.status === "Close") {
            toast({
                ...
                description:
                    "Pengeluaran yang sudah berstatus Close tidak boleh dihapus.",
                variant: "destructive",
            });
            return;
        }
...
>>>>>>> e58dc81 (Perbaikan istilah biaya dan pengeluaran)
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="2025-11">
                                                    November 2025
                                                </SelectItem>
                                                <SelectItem value="2025-12">
                                                    Desember 2025
                                                </SelectItem>
                                            </SelectContent>
                                        </Select>
                                                        ...
                                                        <div className="flex justify-end gap-2">
                                                            ...
                                                            <Button
                                                                ...
                                                                title={
                                                                    expense.status ===
                                                                    "Close"
                                                                        ? "Tidak bisa dihapus: status Close"
                                                                        : "Hapus"
                                                                }
                                                            >
                                                                <Trash2 className="h-4 w-4" />
                            ...
                            <DialogContent className="sm:max-w-lg">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        ...
                                        pengeluaran secara permanen. Pastikan
