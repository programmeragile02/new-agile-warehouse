            ...
            <AppShell>
                <AppHeader
                    ...
                    titleExtra={
                        ...
                        >
                            <b>WhatsApp Setting</b> dipakai untuk mengatur nomor
                            pengirim notifikasi WA. Hubungkan akun, scan QR,
                            lalu kirim notifikasi dari aplikasi.
                        </InfoTip>
                    }
                />
                                ...
                                <div className="space-y-3">
                                    ...
                                    {!status?.ready && (
                                        <div className="text-xs text-muted-foreground">
                                            Buka WhatsApp di ponsel → Perangkat
                                            Tertaut → Tautkan Perangkat → Scan
                                            QR ini.
                                        </div>
                                    )}
                                </div>
