...
//                 Menampilkan{" "}
//                 <span className="font-medium">{total ? from : 0}</span>–
...
//     // Row loading states
//     const [loadingTagihan, setLoadingTagihan] = useState<Set<string>>(
//         new Set()
//     );
...
//                     description:
//                         json?.message || "Terjadi kesalahan saat mengirim WA.",
//                     variant: "destructive",
//                 });
//             }
//         } catch (e: any) {
...
//                                 {/* === Dropdown Unduh (muncul kalau ADA minimal salah satu fitur) === */}
//                                 <FeatureGate
//                                     code={["unduh.tagihan", "unduh.kwitansi"]}
//                                     mode="any"
//                                 >
//                                     <DropdownMenu>
...
//                                                     <DropdownMenuItem
//                                                         disabled
//                                                         title="Fitur tidak termasuk paket"
//                                                     >
//                                                         <FileText />
//                                                         Tagihan (JPG)
//                                                     </DropdownMenuItem>
...
//                                                 <DropdownMenuItem
//                                                     onClick={() =>
//                                                         handleUnduhTagihan(b)
//                                                     }
//                                                     disabled={loadingTagihan.has(
//                                                         b.id
//                                                     )}
//                                                 >
//                                                     <FileText />
...
//                                                 variant="outline"
//                                                 size="sm"
//                                                 className="flex-1 bg-green-500/60 text-white cursor-not-allowed"
//                                                 disabled
//                                                 title="Fitur Kirim WA tidak termasuk paket"
//                                             >
...
//                                                     <DropdownMenuItem
//                                                         onClick={() =>
//                                                             handleKirimWATagihan(
//                                                                 b
//                                                             )
//                                                         }
//                                                         disabled={
//                                                             loadingWATagihan.has(
//                                                                 b.id
//                                                             ) ||
//                                                             !b.wa ||
//                                                             getPelunasanStatus(
...
//                                                     <DropdownMenuItem
//                                                         onClick={() =>
//                                                             handleKirimWAKwitansi(
//                                                                 b
//                                                             )
//                                                         }
//                                                         disabled={
//                                                             loadingWAKwitansi.has(
//                                                                 b.id
//                                                             ) ||
//                                                             !b.wa ||
//                                                             getPelunasanStatus(
...
//                                                             disabled
//                                                             title="Fitur Unduh tidak termasuk paket"
//                                                         >
//                                                             <Download className="h-4 w-4 mr-2" />
//                                                             Unduh
//                                                             <ChevronDown className="h-4 w-4 ml-1 opacity-80" />
...
//                                                                 variant="outline"
//                                                                 size="sm"
//                                                                 className="bg-green-500/60 text-white cursor-not-allowed"
//                                                                 disabled
//                                                                 title="Fitur Kirim WA tidak termasuk paket"
//                                                             >
//                                                                 <MessageCircle className="h-4 w-4 mr-2" />
...
export function BillingTable() {
  ...
  ========================= */
    ...
    async function handleUnduhTagihan(b: BillingItem) {
        try {
            setRowLoading(setLoadingTagihan, b.id, true);
            const url = `/api/unduh/tagihan?${new URLSearchParams({
                tagihanId: b.id,
            }).toString()}`;
            const fallbackName = `tagihan-${b.periode}-${b.namaWarga}-${
                b.pelangganKode || "CUST"
            }.jpg`;
            await downloadBinaryFromApi(url, fallbackName);
        } catch (e: any) {
            console.error(e);
    ...
    async function handleUnduhKwitansi(b: BillingItem) {
        try {
            setRowLoading(setLoadingKwitansi, b.id, true);
            const url = `/api/unduh/kwitansi?${new URLSearchParams({
                tagihanId: b.id,
            }).toString()}`;
            const fallbackName = `kwitansi-${b.periode}-${b.namaWarga}-${
                b.pelangganKode || "CUST"
            }.jpg`;
            await downloadBinaryFromApi(url, fallbackName);
        } catch (e: any) {
