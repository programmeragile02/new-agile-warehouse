...
export function ContactAdmin() {
    ...
    const adminWhatsAppMessage = `Halo Admin Nata Banyu,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-blue-50/50 border border-blue-100/50 rounded-lg text-center">
                    ...
                    <Button
                        ...
                        size="sm"
                        onClick={() =>
                            window.open("mailto:admin@natabanyu.com")
                        }
                        className="bg-transparent"
                    >
                        admin@natabanyu.com
                ...
                <div className="p-4 bg-teal-50/50 border border-teal-100/50 rounded-lg text-center">
                    ...
                    <Button
                        ...
                        onClick={() =>
                            window.open(
                                "https://wa.me/6281234567890?text=Halo Admin Nata Banyu, saya butuh bantuan."
                            )
                        }
                        className="bg-transparent"
                    >
                ...
                <div className="p-4 bg-muted/20 rounded-lg">
                    ...
                    <div className="text-sm space-y-2">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                window.open(
                                    "https://maps.google.com/?q=Tirta+Bening+Office"
                                )
                            }
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            onChange={(e) =>
                                handleInputChange("pesan", e.target.value)
                            }
