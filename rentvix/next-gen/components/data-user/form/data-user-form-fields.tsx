...
export function DataUserFormFields({
    formData,
    setFormData,
    mode,
}: {
...
<div className="space-y-1">
  <Label htmlFor="no_hp" className="text-foreground">Nomor Hp*</Label>
  <Input
    type="number"
    id="no_hp"
    placeholder="e.g., 0812336XXX"
...
<div className="space-y-1">
  ...
  <Input
    type="password"
    id="password"
    placeholder="e.g., masukkan password anda"
